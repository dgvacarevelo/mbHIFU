...
module m_derived_types
    ...
    type subgrid_bubble_physical_parameters
        ...
        real(wp) :: Thost    !< host temperature
    ...
    type bubbles_lagrange_parameters
        ...
        integer  :: write_only_bub_id    !< Write to track a unique bubble with the given id
    ...
    type hifu_parameters
        ...
        logical  :: intPrms
        logical  :: streaming
        real(wp) :: Tref              !< Initial temperature in the domain to start heat eqn
        real(wp) :: K                 !< Dimensionless thermal conductivity (refer to notes)
        real(wp) :: alpha             !< Dimensionless thermal diffusivity (refer to notes)
    ...
    type acoustic_bc_parameters
        ...
        real(wp) :: Pbase    !< Base pressure (atmospheric pressure)
        real(wp) :: rho      !< Density
